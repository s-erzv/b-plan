...
export default function App() {
  ...
  const fetchUserHistory = async () => {
    try {
      ...
      if (profiles.length > 0) {
        ...
        setUsp(latestPrf.usp || "");
        setSpecialOffer(latestPrf.specialOffer || "");
        setKeywords(latestPrf.keywords || "");
      }
    } catch (err) {
  ...
  const handleSelectHistory = (selected: SavedCalendar) => {
    ...
    setUsp(selected.usp || "");
    setSpecialOffer(selected.specialOffer || "");
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-5 bg-white p-6 sm:p-8 rounded-3xl border-2 border-slate-900 shadow-[6px_6px_0px_0px_rgba(15,23,42,1)] flex flex-col gap-6">
                  ...
                  <form onSubmit={handleGenerateCalendar} className="flex flex-col gap-5 text-left">
                    ...
                    {/* input usp */}
                    <div className="flex flex-col gap-1.5">
                      <label htmlFor="input-usp" className="font-display font-extrabold text-xs text-slate-800 uppercase tracking-wider flex items-center gap-1">
                        Keunggulan Utama / USP <span className="text-[10px] text-slate-400 lowercase font-normal">(opsional)</span>
                      </label>
                      <input
                        id="input-usp"
                        type="text"
                        ...
                        placeholder="Contoh: Terbuat dari kopi robusta Gayo organik, manisnya pas"
                        className="w-full px-4 py-3 bg-white border-2 border-slate-900 rounded-xl font-sans text-sm font-bold text-slate-900 outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-600 transition shadow-[2px_2px_0px_0px_rgba(15,23,42,1)]"
                      />
                    </div>
                    ...
                    {/* input specialOffer */}
                    <div className="flex flex-col gap-1.5">
                      <label htmlFor="input-offer" className="font-display font-extrabold text-xs text-slate-800 uppercase tracking-wider flex items-center gap-1">
                        Diskon / Penawaran Spesial Aktif <span className="text-[10px] text-slate-400 lowercase font-normal">(opsional)</span>
                      </label>
                      <input
                        id="input-offer"
                        type="text"
                        ...
                        placeholder="Contoh: Beli 2 Gratis 1 s.d akhir pekan ini"
                        className="w-full px-4 py-3 bg-white border-2 border-slate-900 rounded-xl font-sans text-sm font-bold text-slate-900 outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-600 transition shadow-[2px_2px_0px_0px_rgba(15,23,42,1)]"
                      />
                    </div>
                    ...
                    {/* input keywords */}
                    <div className="flex flex-col gap-1.5">
                      <label htmlFor="input-keywords" className="font-display font-extrabold text-xs text-slate-800 uppercase tracking-wider flex items-center gap-1">
                        Kata Kunci Wajib <span className="text-[10px] text-slate-400 lowercase font-normal">(opsional)</span>
                      </label>
                      <input
                        id="input-keywords"
                        type="text"
                        ...
                        placeholder="Contoh: kopi lokal, nongkrong seru, booster energi"
                        className="w-full px-4 py-3 bg-white border-2 border-slate-900 rounded-xl font-sans text-sm font-bold text-slate-900 outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-600 transition shadow-[2px_2px_0px_0px_rgba(15,23,42,1)]"
                      />
                    </div>
